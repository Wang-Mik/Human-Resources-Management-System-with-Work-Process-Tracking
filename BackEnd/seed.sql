...
VALUES 
    ...
    (N'Phan Quang Minh', 'minh@hospital.com', 'password123', 'Manager', 'Internal Medicine', 'Manager', 'Active'),
    (N'David Hưng', 'hung@hospital.com', 'password123', 'Employee', 'Emergency Room', 'Head ER', 'Active'),
    (N'Madam Dung', 'dung@hospital.com', 'password123', 'Employee', 'Emergency Room', 'Doctor', 'Active'),
    (N'Nguyễn Lan', 'lan@hospital.com', 'password123', 'Employee', 'ICU', 'Technician', 'Active'),
    (N'Nguyễn Nurse', 'nguyen@hospital.com', 'password123', 'Employee', 'Cardiology', 'Nurse', 'Active');
GO
